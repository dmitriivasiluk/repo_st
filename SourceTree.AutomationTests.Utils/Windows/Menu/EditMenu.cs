...
namespace SourceTree.AutomationTests.Utils.Windows.MenuFolder
{
    public class EditMenu : MenuBar
    {
        ...
        public override TestStack.White.UIItems.MenuItems.Menu UIElementMenu { get { return MainWindow.Get<TestStack.White.UIItems.MenuItems.Menu>(SearchCriteria.ByText("Edit")); } }
