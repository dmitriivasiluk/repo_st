...
namespace SourceTree.AutomationTests.Utils.Windows.Menu.Action
{
    public class ResolveConflict : ActionsMenu
    {
        ...
        public TestStack.White.UIItems.MenuItems.Menu UIElementSubMenu { get { return UIElementMenu.SubMenu("Resolve Conflicts"); } }
