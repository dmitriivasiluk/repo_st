...
namespace SourceTree.AutomationTests.Utils.Windows.Menu
{
    public class ViewMenu : MenuBar
    {
        ...
        public override TestStack.White.UIItems.MenuItems.Menu UIElementMenu { get { return MainWindow.Get<TestStack.White.UIItems.MenuItems.Menu>(SearchCriteria.ByText("View")); } }
